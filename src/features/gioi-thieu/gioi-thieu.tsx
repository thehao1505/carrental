      ...
      <main className="text-gray-800">
        ...
        <section className="max-w-5xl mx-auto px-6 py-12">
          ...
          <p className="mb-4">
            ...
            <strong>DVDL Đại Dương Ban Mê</strong> mang trong mình khát vọng
            mang đến những chuyến đi không chỉ là trải nghiệm, mà còn là hành
            trình khám phá văn hóa, thiên nhiên và con người. Chúng tôi bắt đầu
            từ một nhóm những người yêu du lịch, khao khát xây dựng một dịch vụ{" "}
        ...
        <section className="max-w-5xl mx-auto px-6 py-12">
          ...
          <ul className="list-disc pl-5 space-y-3 text-gray-700">
            ...
            <li>
              ...
              DVDL Đại Dương Ban Mê luôn đem đến cho Quý khách những chuyến đi
              tuyệt vời nhất. Thời gian tới, hy vọng chúng tôi sẽ có cơ hội được
              phục vụ quý khách
            </li>
          </ul>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <ul className="list-disc pl-5 space-y-3 text-gray-700">
                ...
                <li>
                  Đón tiếp và tổ chức cho các cá nhân, tổ chức, doanh nghiệp
                  trong nước và nước ngoài đến Đăk Lăk công tác, khảo sát thị
                  trường ….
                </li>
              </ul>
            </div>
